...
// the StarburstAddon object against the actual cluster state, and then
...
func (r *StarburstAddonReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// if addon is not found, we will stop reconciling
	addon := &managedtenantsv1alpha1.StarburstAddon{}
...
func (r *StarburstAddonReconciler) DeployCronJob() *batchv1.CronJob {
...
func (r *StarburstAddonReconciler) DeployServiceMonitor() *promv1.ServiceMonitor {
...
func (r *StarburstAddonReconciler) DeployPrometheusRules() *promv1.PrometheusRule {
...
func (r *StarburstAddonReconciler) DeployPrometheus(tokenURL, remoteWriteURL, clusterID string) *promv1.Prometheus {
...
func (r *StarburstAddonReconciler) DeployLicenseSecret(ctx context.Context, license, namespace string) *corev1.Secret {
	logger := log.FromContext(ctx)
...
func (r *StarburstAddonReconciler) DeployFederationServiceMonitor() *promv1.ServiceMonitor {
